 ...
 */
public class MongodbCmisService extends AbstractCmisService implements CallContextAwareCmisService {

    private final MongodbRepositoryManager repositoryManager;
    private CallContext context;

    public MongodbCmisService(final MongodbRepositoryManager repositoryManager) {
     ...
     */
    public MongodbRepository getRepository() {
    ...
    public RepositoryInfo getRepositoryInfo(String repositoryId, ExtensionsData extension) {
        for (MongodbRepository fsr : repositoryManager.getRepositories()) {
