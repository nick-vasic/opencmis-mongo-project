 ...
 */
public class MongodbTypeManager {

    private static final Logger LOG = LoggerFactory.getLogger(MongodbTypeManager.class);

    private static final String NAMESPACE = "http://chemistry.apache.org/opencmis/mongodb";

    private final TypeDefinitionFactory typeDefinitionFactory;
    private final Map<String, TypeDefinition> typeDefinitions;

    public MongodbTypeManager() {
