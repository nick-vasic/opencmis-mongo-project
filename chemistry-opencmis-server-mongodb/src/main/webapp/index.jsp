...
<%@ page import="org.apache.chemistry.opencmis.mongodb.*" %>
<%@ page import="org.apache.chemistry.opencmis.commons.definitions.*" %>
<%
	MongodbCmisServiceFactory factory = (MongodbCmisServiceFactory) application.getAttribute("org.apache.chemistry.opencmis.servicesfactory");
%>
...
<%
	for (MongodbRepository fsr: factory.getRepositoryManager().getRepositories()) {
%>
